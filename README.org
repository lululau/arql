...
*** Configuration Files
    ...
    the =teachers= table will be generated for the table, and a constant alias named =LS= will be created for the =Seito=
...
**** =t=
     ...
     For example, only =name= show , =age= and all properties whose names contain the =time= word :
